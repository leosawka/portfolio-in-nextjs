...
export const texts = {
  en: {
    ...
    stack: {
      labels: ['Languages', 'Frontend', 'Backend', 'Databases', 'DevOps', 'Testing', 'Artificial inteligence', 'Tools', 'Soft skills', 'Languages spoken'],
  ...
  es: {
    ...
    stack: {
      labels: ['Lenguajes', 'Frontend', 'Backend', 'Bases de datos', 'DevOps', 'Testing', 'Inteligencia artificial', 'Herramientas', 'Habilidades blandas', 'Idiomas'],
      languages: ['JavaScript', 'Typescript', 'Python', 'Java', 'SQL', 'C#', 'Bash', 'HTML', 'CSS'],
      frontend: ['React', 'Redux', 'Next', 'TailwindCSS', 'MaterialUI', 'Bootstrap', 'Responsive design', 'Accessibility', 'UX writing'],
      backend: ['NodeJs', 'Express', 'FastAPI', 'Django', 'GraphQL', 'RESTful API design', 'OAuth2', 'Token authentication', 'Access Control', 'Microservices', 'MVC'],
      databases: ['MySQL', 'PostgreSQL', 'MongoDB', 'SQLite'],

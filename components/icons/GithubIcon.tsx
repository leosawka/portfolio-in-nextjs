...
export const GithubIcon = ({ theme, size = 32 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      ...
      d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 
         ...
         -.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.65 7.65 0 012-.27
         c.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44
         1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07
